...
function FeatureCard({ title, description }) {
  return (
    <motion.div whileHover={{ scale: 1.05 }} className="p-6 rounded-3xl bg-white/5 border border-white/10 shadow-lg backdrop-blur-md transition-transform">
...
function CompareCard({ title, description }) {
  return (
    <motion.div whileHover={{ scale: 1.03 }} className="p-6 rounded-3xl bg-white/5 border border-white/10 shadow-lg backdrop-blur-md transition-transform">
...
export default function BatakBeautifulSite() {
  ...
  return (
    <div className="bg-[#07060A] text-white min-h-screen font-sans overflow-x-hidden relative">
      {/* Background Circles */}
      ...
      <section className="flex flex-col items-center justify-center h-screen text-center px-8 relative">
        <motion.h1 initial={{ opacity: 0, y: 50, scale: 0.95 }} animate={{ opacity: 1, y: 0, scale: 1 }} transition={{ duration: 1 }} className="text-6xl md:text-7xl font-extrabold mb-6 leading-tight">The Architecture of Batak Houses</motion.h1>
        <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.3 }} className="text-xl md:text-2xl text-white/70 max-w-3xl">Discover how these traditional homes of North Sumatra blend practicality, artistry, and meaning in every detail.</motion.p>
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.6 }} className="mt-12">
          <a href="#architecture" className="px-10 py-4 bg-gradient-to-r from-purple-700 to-teal-400 rounded-full font-semibold hover:scale-105 transition-transform shadow-lg">Explore</a>
        </motion.div>
      </section>
      ...
      <motion.section id="compare" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={sectionVariants} className="max-w-6xl mx-auto px-8 py-32">
        <motion.h2 initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="text-4xl md:text-5xl font-bold text-center mb-16">How Do They Compare?</motion.h2>
      ...
      <motion.section id="aus-compare" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={sectionVariants} className="max-w-6xl mx-auto px-8 py-32">
        <motion.h2 initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="text-4xl md:text-5xl font-bold text-center mb-16">Batak Houses vs Australian Houses</motion.h2>
        <motion.div variants={staggerContainer} className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
      ...
      <motion.section id="minecraft" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={sectionVariants} className="max-w-6xl mx-auto px-8 py-32">
        <motion.h2 initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="text-4xl md:text-5xl font-bold text-center mb-12">The House built in Minecraft</motion.h2>
        <div className="p-8 rounded-3xl bg-white/5 border border-white/10 shadow-lg backdrop-blur-md flex flex-col gap-6">
          ...
          <div className="aspect-w-16 aspect-h-9">
            <iframe className="w-full h-full rounded-2xl border border-white/10" src="https://www.youtube.com/embed/YOUR_VIDEO_ID" title="Minecraft Batak House" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
          </div>
        </div>
      </motion.section>
      ...
      <section id="bibliography" className="max-w-6xl mx-auto px-8 py-32">
        ...
        <ul className="space-y-3 text-white/70 list-disc list-inside">
          <li>ArtAsia (n.d.). Indonesian Architecture: The Batak House. <a href="http://artasia.www2.50megs.com/Indonesia/houses.html" target="_blank" rel="noopener noreferrer" className="underline hover:text-teal-400">Link</a> [Accessed 31 July 2025]</li>
          <li>Hanan, H. and Wonorahardjo, S. (2012). The Architecture of Batak Toba: An Expression of Living Harmoniously. <a href="https://ph01.tci-thaijo.org/index.php/nakhara/article/view/104899" target="_blank" rel="noopener noreferrer" className="underline hover:text-teal-400">Link</a> [Accessed 31 July 2025]</li>
          <li>Nasution, A.H., Usman, B. and Musyirwan, N. (2015). The Values of Local Wisdom on Toba Batak Traditional House. <a href="https://doi.org/10.1016/j.sbspro.2015.08.229" target="_blank" rel="noopener noreferrer" className="underline hover:text-teal-400">DOI</a></li>
        </ul>
      </section>

  ...
  return (
    <div className="bg-[#0a0a0d] text-white font-sans overflow-x-hidden">
      ...
      <motion.section
        ...
        animate={zoomed ? { scale: 2, rotateX: 20, rotateY: 10, opacity: 0, transition: { duration: 1.2 } } : {}}
      >
        ...
        {zoomed && (
          <motion.button
            onClick={scrollToBibliography}
            className="fixed top-6 right-6 px-6 py-3 bg-purple-600/80 rounded-full text-white font-semibold hover:bg-purple-500 transition"
          >
            Bibliography
          </motion.button>
        )}

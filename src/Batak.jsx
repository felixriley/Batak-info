...
export default function Batak() {
  ...
  const handleDiscover = () => {
    setUnlocked(true);
    // Scroll to the first content section with smooth animation
  ...
  return (
    <div className="bg-[#0a0a0d] text-white font-sans overflow-x-hidden">
      ...
      {/* MAIN CONTENT (scrollable after unlock) */}
      <main ref={mainRef} className={`transition-all duration-1000 ${unlocked ? "" : "pointer-events-none"}`}>
        {/* FEATURES */}
